...
define dso_local void @_Z13complex_loopsi(i32 noundef %0) #0 {
...
6:                                                ; preds = %11, %1
  %7 = phi i32 [ 1, %11 ], [ %.promoted1, %1 ]
  %8 = phi i32 [ %12, %11 ], [ %.promoted, %1 ]
  %9 = icmp slt i32 %8, %5
...
define dso_local noundef i32 @main() #1 {
  ...
  call void @_Z13complex_loopsi(i32 noundef 5)
  ret i32 0
}
